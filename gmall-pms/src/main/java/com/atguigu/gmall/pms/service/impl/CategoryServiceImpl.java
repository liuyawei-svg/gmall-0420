...
public class CategoryServiceImpl extends ServiceImpl<CategoryMapper, CategoryEntity> implements CategoryService {
    ...
    public List<CategoryEntity> queryCategoriesByCid3(Long cid3) {
        ...
        //查询二级分类
        CategoryEntity lvl2CategoryEntity = this.categoryMapper.selectById(lvl3CategoryEntity.getId());
        //查询一级分类
        CategoryEntity lvl1CategoryEntity = this.categoryMapper.selectById(lvl2CategoryEntity.getId());

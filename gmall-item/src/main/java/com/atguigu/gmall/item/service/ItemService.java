    ...
    public ItemVo loadData(Long skuId) {
        ...
        CompletableFuture<Void> wareCompletableFuture = CompletableFuture.runAsync(() -> {
            ...
            if (!CollectionUtils.isEmpty(wareSkuEntities)) {
                itemVo.setStore(wareSkuEntities.stream().allMatch(wareSkuEntity -> wareSkuEntity.getStock() - wareSkuEntity.getStockLocked() > 0));
            }
        },threadPoolExecutor);
        //8.查询spu所有的销售属性
        ...
        cateCompletableFuture.allOf(cateCompletableFuture, brandCompletableFuture, spuCompletableFuture,

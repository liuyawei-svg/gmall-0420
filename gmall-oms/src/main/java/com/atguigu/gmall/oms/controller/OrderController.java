...
public class OrderController {
    ...
    public ResponseVo<OrderEntity> savaOrder(@RequestBody OrderSubmitVo submitVo,@PathVariable("userId")Long userId){
        OrderEntity orderEntity = this.orderService.savaOrder(submitVo,userId);
        return ResponseVo.ok(orderEntity);
    }
